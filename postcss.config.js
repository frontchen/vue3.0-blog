module.exports = {
  plugins: {
    ...
    "postcss-px-to-viewport": {
      ...
      selectorBlackList: ['navbar','hamburger-container','breadcrumb-container','hamburger','resetTop','right-panel','scrollbar-wrapper','submenu-title-noDropdown{'], //指定不转换视窗单位值得类，可以自定义，可以无限添加
